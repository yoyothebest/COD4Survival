...
set_animarray_standing()
{
	...
	else
	{
		...
		else if ( self isCQBWalking() )
		{
			...
			{
				self.a.array["straight_level"] = %juggernaut_aim5;
				self.a.array["reload"] = array( %juggernaut_stand_reload );
				self.a.array["reload_crouchhide"] = array( %juggernaut_stand_reload );
			}
			else
			{
		...
		if ( isDefined( self.juggernaut ) )
			self.a.array[ "exposed_idle" ] = array( %juggernaut_stand_idle );
		else
			self.a.array["exposed_idle"] = array( %exposed_idle_alert_v1, %exposed_idle_alert_v2, %exposed_idle_alert_v3 );
